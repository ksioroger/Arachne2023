...
class CoreArbiterServer {
  ...
  private:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /***
     * Esta função identifica as threads em execução e caso uma thread demore para processar ela irá preemptar a thread.
     * 
     * This function identifies the running threads and if a thread takes too long to process it will preempt the thread.
    */
    void listarThreadsArachne();
    /***
     * Esta função realiza a preempção de uma thread recebida.
     * 
     * This function performs the preemption of an incoming thread.
    */
    void ThreadPreemption_portempo(struct ThreadInfo* thread);
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     * Um mapa para armazenar as threads em execução que demoram para liberar o núcleo.
     * 
     * A map to store running threads that take time to release the core.
     * */ 
    std::unordered_map<unsigned int, decltype(std::chrono::high_resolution_clock::now()) > listaThreadsExecutandoUM;
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     * Define um tempo para forçar preemptar uma thread de longa duração.
     * 
     * Sets a time to force preempt a long-running thread.
     * */ 
    //int timeToPreempt;
    uint64_t timeToPreempt;
    /***
     * Uma flag de controle que identifica a quantidade de vezes que uma função foi executada, 
     * e quando atinge um valor(10) limpa as entradas do mapa de threads em execução que não estão executando.
     * 
     * A control flag that identifies the number of times a function has been executed, 
     * and when it reaches a value (10) it clears the entries from the map of running threads that are not executing.
    */
    int timeToCleanUM;
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
